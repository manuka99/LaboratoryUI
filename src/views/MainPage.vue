                ...
                <div class="card">
                  <div class="card-body">
                        ...
                        >
                          <div class="d-flex me-5">
                            ...
                            <div class="ps-2">
                              ...
                              <span
                                class="font-10 font-weight-semibold text-muted"
                                >TOTAL SALES</span
                              >
                            </div>
                          </div>
                    ...
                    <p class="text-muted font-13 mt-2 mt-sm-0">
                      ...
                      <a class="text-muted font-13" href="#"
                        ><u>Learn more</u></a
                      >
                    </p>
                  ...
                  <div class="card-body">
                    <div class="d-flex justify-content-between">
                      <div class="card-title">
                        ...
                        <small class="d-block text-muted"
                          >August 01 - August 31</small
                        >
                      </div>
                      <div class="d-flex text-muted font-20">
                        <i class="mdi mdi-printer mouse-pointer"></i>
                        <i
                          class="mdi mdi-help-circle-outline ms-2 mouse-pointer"
                        ></i>
                      </div>
                    </div>
                    <h3 class="font-weight-bold mb-0">
                      ...
                      <span class="text-success h5"
                        >4,5%<i class="mdi mdi-arrow-up"></i
                      ></span>
                    </h3>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <h3 class="font-weight-bold mb-0">
                      0.40%
                      <span class="text-success h5"
                        >0.20%<i class="mdi mdi-arrow-up"></i
                      ></span>
                    </h3>
                    <span class="text-muted font-13">Avg customers/Day</span>
              ...
              <div class="col-sm-4 stretch-card grid-margin">
                <div class="card">
                  ...
                  <div class="card-body px-3 text-dark">
                    ...
                    <div
                      class="d-flex justify-content-between font-weight-semibold"
                    >
                      <p class="mb-0">
              ...
              <div class="col-xl-8 stretch-card grid-margin">
                <div class="card">
                  ...
                  <div class="card-body p-0">
                    ...
                    <a
                      class="text-black d-block ps-4 pt-2 pb-2 pb-lg-0 font-13 font-weight-bold"
                      href="#"
                      >Show more</a
                    >
                  </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-6 col-xl-4 stretch-card grid-margin">
                <div class="card color-card-wrapper">
                  <div class="card-body">
                    <img
                      class="img-fluid card-top-img w-100"
                      src="@/assets/images/dashboard/img_5.jpg"
                      alt=""
                    />
                    <div
                      class="d-flex flex-wrap justify-content-around color-card-outer"
                    >
