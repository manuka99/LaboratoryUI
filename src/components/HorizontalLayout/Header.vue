    ...
    <nav class="navbar top-navbar col-lg-12 col-12 p-0">
      <div class="container">
        ...
        >
              ...
              >
                ...
                <div class="nav-profile-text">
                  ...
                  <span class="font-13 online-color"
                    >online <i class="mdi mdi-chevron-down"></i
                  ></span>
                </div>
              </a>
              <div
                class="dropdown-menu navbar-dropdown"
                :class="showProfileMenu ? 'd-block' : 'd-none'"
          ...
          >
            <span class="mdi mdi-menu" @click="showNavbar = !showNavbar"></span>
          </button>
        </div>
      </div>
    </nav>
    <nav
      class="bottom-navbar d-md-flex"
      :class="showNavbar ? 'd-flex' : 'd-none'"
    >
      <div class="container">
